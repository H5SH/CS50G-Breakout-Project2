...
function PlayState:update(dt)
    ...
    if self.ball:collides(self.paddle) then
        ...
        for k, brick in pairs(self.bricks) do
            ...
            if brick.inPlay and (self.ball:collides(brick) or self.ball2:collides(brick)) then
                -- add to score
                ...
                PlayState:ballCollidesBrick(self.ball)
                PlayState:ballCollidesBrick(self.ball2)

                -- slightly scale the y velocity to speed up the game, capping at +- 150
                if math.abs(self.ball.dy) < 150 or math.abs(self.ball.dy) < 150 then
...
function PlayState:ballCollidesBrick(ball)
